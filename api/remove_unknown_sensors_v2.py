"""
Remove sensores com sensor_type='unknown' que são duplicatas
"""
...
def remove_unknown_sensors():
    ...
    try:
        ...
        print(f"\n{'='*80}")
        print(f"TOTAL A REMOVER:")
        print(f"  Sensores: {len(unknown_sensors)}")
        print(f"  Métricas: {total_metrics}")
        print(f"{'='*80}\n")
        
        confirm = input("Deseja remover estes sensores? (sim/não): ")
